...
const REASONS: Reason[] = [
  {
    component: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="52" height="52" fill="#464646">
  ...
  {
    component: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="52" height="52" fill="#464646">
...
export default function WhyItMatters() {
  return (
    <section className="base relative bg-blue-100 text-white overflow-hidden">
      <div className="relative mx-auto max-w-6xl px-6 py-16 md:py-20">
        ...
        <div className="relative text-center mb-8">
          ...
          <h2 className="mt-2 font-fredoka capitalize font-extrabold text-3xl sm:text-4xl md:text-5xl text-blue-400 leading-tight">
        ...
        <div className="relative z-10 -mt-14 grid grid-cols-1 md:grid-cols-3 gap-6">
          {REASONS.map((r) => (
            ...
            >
              {r.component ? (
                <span className="opacity-90 text-[#464646]">{r.component}</span>
              ) : r.icon ? (
                <Image src={r.icon} alt="" width={52} height={52} className="opacity-90" />
              ) : null}
              <p className="font-poppins font-semibold text-base text-neutral-600 leading-snug">
                {r.label}
              </p>
            </div>
          ))}
