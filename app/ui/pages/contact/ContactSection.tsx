      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 pt-28 navdesk:pt-10 py-10 md:px-8 lg:grid-cols-2 lg:py-20">
        ...
        <div className="flex items-center justify-center">
          <div className="w-full max-w-lg rounded-3xl px-4 py-8 md:px-10">
            <div>
              <h1 className="mt-4 leading-9 font-bold tracking-tight text-blue-500">
                Contact Us
              </h1>
              <p className="mt-4 max-w-sm text-neutral-600">
                We’re here to serve—reach out and we’ll be in touch soon.
              </p>
            </div>
...
const defaultColors = [
  ...
  "#067099", // Layer 1: vibrant blue
  "#C81E1E", // Layer 2: hot pink/magenta
  "#ffd60a", // Layer 3: golden yellow
  "#287526", // Layer 4: bright red
];
