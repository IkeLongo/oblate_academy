...
export function VirtuesHub({ grade, gradeHref, cards }: VirtuesHubProps) {
  return (
    <div className="base bg-gradient-to-b from-blue-100 via-gray-100 to-blue-100 mx-auto px-6 py-20 navdesk:py-16">
      <div className="max-w-6xl mx-auto pt-16 navdesk:pt-0">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-10">
          ...
          <div className="md:min-w-[280px]">
            <HubGradeSwitcher grade={grade} basePath="virtues" />
          </div>
        </div>
